...
const WhySui = () => {
    ...
    return (
        <section id='whysui' className="mx-[6%] lg:mx-[8%] 4xl:mx-auto 4xl:max-w-[1920px] mt-14 lg:mt-[134px] text-center">
          ...
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 text-secondary">
            <div className="" data-animate>
              <div className="relative">
                <Image width={143} height={117} className="mx-auto" alt='Why sui 1' src="/img/renft/wallet_icon.png" />
              </div>
            ...
            <div className="" data-animate>
              <div className="relative">
                <Image width={143} height={117} className="mx-auto" alt='Why sui 3' src="/img/renft/throughput_icon.png" />
              </div>
              <p className='text-lg sm:text-2xl font-bold mt-8 sm:max-w-[199px] mx-auto'>
