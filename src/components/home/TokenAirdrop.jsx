...
const TokenAirdrop = () => {
    return (
        <section id='airdrop' className='mx-[8%] pt-20 lg:pt-[134px] text-center'>
          <h4 className='text-3xl xs:text-4xl sm:text-[40px] lg:text-5xl text-secondary lg:leading-[80px] font-black'>
            Our Massive 
            <span className='text-primary'> FEAST Token Airdrop</span>
          </h4>
          <div className="mt-20 lg:flex flex-row-reverse gap-6">
            <div className="">
