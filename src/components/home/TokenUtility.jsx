...
const TokenUtility = () => {
    ...
    return (
        <section id='token-utility' className="mx-[2%] lg:mx-[8%] mt-10 sm:mt-20 lg:mt-[180px] text-center md:pb-52">
          ...
          <div id='utility-items' className="mt-10 sm:mt-20 lg:mt-[133px] flex flex-wrap md:flex-nowrap gap-5 justify-center">
            <div id='staking' data-animate className="bg-white border border-[#6FBCF0] rounded-[32px] z-30 max-w-[300px] md:translate-y-[26px] md:translate-x-9 lg:translate-x-[42px]">
            ...
            <div id='' className="bg-white border border-[#6FBCF0] rounded-[32px] z-20 max-w-[300px] md:translate-y-[75%]">
            ...
            <div id='whitelisting' data-animate className="bg-white border border-[#6FBCF0] rounded-[32px] z-10 max-w-[300px] md:-translate-x-9 lg:-translate-x-[48px]">
              <div className="px-6 lg:px-8 py-[38px] min-h-[230px] lg:min-h-full">
