        ...
        <section id='community' className='mt-[83px] bg-custom-gradient pb-[170px] mb-[200px]'>
          ...
          <div className="absolute z-10 w-full">
            <div className="relative mx-[8%] lg:mx-[10%] bg-white md:flex items-center gap-3 shadow-xl justify-between rounded-[32px] px-7 xs:px-9 lg:px-12 py-8 xs:py-10 lg:py-16 mt-12 ">
              <div className="">
                <h6 className='text-2xl lg:text-[32px] text-secondary font-bold text-center md:text-left'>Join the party!</h6>
                <p className='text-base lg:text-xl font-light mt-3 md:max-w-[220px] lg:max-w-[350px] xl:max-w-[480px] text-center md:text-left'>It’s Link gem feast for every NFT enthusiast on the SUI blockchain</p>
              </div>
