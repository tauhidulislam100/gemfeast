    ...
    <div className="pt-24 md:pt-32 lg:pt-[166px] 3xl:pt-[188px] mx-[4%] md:mx-[6%] lg:mx-[8%] 4xl:mx-auto 4xl:max-w-[1920px] transition-all duration-500 ease-in-out">
      ...
      <div id="marketplace" className="mt-4 2xl:mt-12">
        <div className="flex-1">
          <h1
            data-animate
            className="text-3xl lg:text-4xl 2xl:text-[54px] text-secondary 2xl:leading-[80px] font-bold text-center"
          >
          ...
          <p
            data-animate
            className="text-base sm:text-lg 2xl:text-2xl lg:leading-9 text-[#6D6F6E] font-medium mt-3 lg:mt-5 2xl:mt-7"
          >
            Create, Collect and Invest in premium NFT assets on the SUI network.
            Our community driven approach makes NFT trading fun and lets you
            earn while doing it. And if you are in it for the art, you are
            welcome to feast with us.
          </p>
          <div data-animate className="mt-6 2xl:mt-10 flex items-center gap-3">
            <button className="px-7 lg:px-12 py-2 lg:py-3.5 transition-all duration-300 ease-in-out text-base 2xl:text-xl font-medium md:font-semibold text-white bg-custom-gradient rounded-full">
              Explore
            </button>
            <Link href={'/'}>
              <button className="px-6 flex items-center gap-3 text-base 2xl:text-xl text-primary font-semibold whitespace-nowrap hover:text-secondary">
                Join our community <HiOutlineArrowRight />
              </button>
            </Link>
          </div>
        </div>
