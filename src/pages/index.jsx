...
export default function Home() {
  ...
  return (
    <div ref={homeRef} id="body" className='md:bg-[url("/img/renft/background.jpg")] bg-no-repeat bg-fixed bg-cover'>
      {
        isMounted ? 
        <>
        ...
        <div className="min-h-screen h-screen flex justify-center items-center">
          <div className="text-3xl animate-spin text-primary">
            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M3.055 13H5.07a7.002 7.002 0 0 0 13.858 0h2.016a9.001 9.001 0 0 1-17.89 0zm0-2a9.001 9.001 0 0 1 17.89 0H18.93a7.002 7.002 0 0 0-13.858 0H3.055z"></path></g></svg>
          </div>
        </div>
      }
    </div>
